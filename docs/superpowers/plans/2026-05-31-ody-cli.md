...
- [ ] **Step 6: Implement the config store**
...
- [ ] **Step 9: Implement the entry-point dispatcher**
...
- [ ] **Step 10: Verify the dispatcher runs**
...
- [ ] **Step 5: Wire publish into the ingest route**
...
- [ ] **Step 1: Write the failing auth/ownership test**
...
- [ ] **Step 3: Implement the listen command**
...
- [ ] **Step 5: Add the backfill function and a test for it**
...
- [ ] **Step 7: Implement `backfillSince` and wire `--since`**
...
- [ ] **Step 9: Confirm the build still passes**
...
- [ ] **Step 1: Add `headersJson` to the event detail DTO**
...
- [ ] **Step 2: Confirm the server build still passes**
...
- [ ] **Step 3: Write the failing trigger test**
...
- [ ] **Step 5: Implement the trigger command**
...
- [ ] **Step 7: Register the command in the dispatcher**
...
- [ ] **Step 8: Confirm both builds pass**
...
- [ ] **Step 2: Add an infra note for the SSE endpoint**
...
- [ ] **Step 1: Boot the dev stack** (three terminals)
...
- [ ] **Step 2: Mint a token and log in**
...
- [ ] **Step 3: Start a local sink and listen**
...
- [ ] **Step 4: Trigger an event and verify it lands**
...
- [ ] **Step 5: Verify reconnect + backfill**
